    ...
    <div class="purchase">
        ...
        <div class="purchase__left">
            ...
            <div class="purchase__payment">
                ...
                <div class="purchase__payment-error">
            ...
            <div class="purchase__address">
                ...
                <div class="purchase__address-error">
                    @error('postal_code')
                    {{ $message }}
                    @enderror
                </div>
            ...
            <div class="purchase__summary-wrapper">
                <div class="purchase__summary">
                    ...
                    <p class="purchase__summary-value">
                        <span class="purchase__summary-symbol">&yen;</span>
                        {{ number_format($item->price) }}
                    </p>
                </div>
                <div class="purchase__summary">
                    <p class="purchase__summary-label">支払い方法</p>
                    <p class="purchase__summary-value purchase__summary-value--method" id="summary-method"></p>
                </div>
            </div>
